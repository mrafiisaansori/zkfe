...
import { Card, CardBody, Button, DataTable, FilterDate, ConfirmDialog, Badge, Select, Pagination, type Column } from '@/components/ui';
    ...
    <div>
      ...
      <Card className="mb-4"><CardBody>
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end">
          ...
          />
          <Select label="Status" value={status} onChange={(e) => { setStatus(e.target.value as '1' | '0'); setPage(1); }}
